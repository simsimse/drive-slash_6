...
/// Dash, PlayerForceController, MagnetForce 등이 모두 이 컴포넌트를 참조합니다.
/// </summary>
/// <remarks>
/// [참조하는 곳]
/// - MagnetForce.cs  : IsPullMode 로 인력/척력 방향 결정
/// - Repeller.cs     : IsPullMode=false(척력) 일 때만 패링 발동
/// [같은 GameObject에 필요한 컴포넌트]
/// - MagnetForce (RequireComponent로 강제)
/// </remarks>
public class ForceMode : MonoBehaviour
{
    // MagnetForce, Repeller 에서 읽기 전용으로 참조
